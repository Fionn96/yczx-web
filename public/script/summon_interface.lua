...
function InitSummonData(id, skill_level, player, monster, index)
	...
	elseif id == 45509 or id == 50638 or id == 50639  then
		...
		local _,huolieYingju		= player:PlayerQuerySkilllvl(6869)	--火猎护主·萤炬
		local _,huolieHaoyue		= player:PlayerQuerySkilllvl(6870)	--火猎护主·皓月
		local _,huolieXiri			= player:PlayerQuerySkilllvl(6871)	--火猎护主·曦日
